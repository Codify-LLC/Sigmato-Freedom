...
class FreedomCircleWidget extends StatefulWidget {
  const FreedomCircleWidget({Key? key}) : super(key: key);

  @override
  _FreedomCircleWidgetState createState() => _FreedomCircleWidgetState();
}

class _FreedomCircleWidgetState extends State<FreedomCircleWidget> {
